        ...
        <div class="container">
            ...
            <p>
                ...
                if (isset($_SESSION['username'])) {
                    ...
                    $welcome = "<h2>Welcome, <u>$username!</u><h2>";
                    ...
                    echo '<div class="signup-links">';
                    echo '<b><a href="views/login_view.php">Click here to log in</a></b>';
                    echo '<b>or</b>'; // Keeping "or" inline
                    echo '<b><a href="views/registration_view.php">sign up here</a></b>';
                    echo '</div>'; // Closing the signup links div
                }
                ?>
            </p>
